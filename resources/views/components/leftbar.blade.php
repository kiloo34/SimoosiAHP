<aside id="leftsidebar" class="sidebar">
    <ul class="nav nav-tabs">
        <li class="nav-item"><a class="navbar-brand" data-toggle="tab" href="{{ route('dashboard.index') }}">SimooSi</a>
        </li>
        ...
        <div class="tab-pane stretchRight active" id="dashboard">
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="{{ route('rekomendasi.index') }}"><i class="material-icons">thumb_up</i>
